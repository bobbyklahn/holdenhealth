        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {category.pdf && (
            <Link
              ...
              className="inline-flex items-center gap-2 mt-8 text-sm font-semibold text-white/90 hover:text-white transition-colors border border-white/30 px-4 py-2 rounded-lg"
            >
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-2 text-gray-700 text-sm">
                          {product.features.map((feature, index) => (
                            <li key={`${product.slug}-feature-${index}`} className="flex items-start gap-2">
